...
class BuyCommandCog(commands.Cog):
    ...
    async def buy(self, ctx: SlashContext):
        ...
        embed.set_footer(text=".gg/zeroservices ┃ Made by revilomm", icon_url="https://cdn.discordapp.com/attachments/1187683452603093002/1187761268975747152/Logo.gif?ex=65980fe2&is=65859ae2&hm=925938dc49562f6bde33330f610a1a3a1711dd3bbac88c5f981520287bac866f&")
        await ctx.send(
            embed=embed,
            components=[
                {
